	...
	private void getUIEvents() {
		  			...
		  			try {
		  			  sofrom_Text = (Text) event.widget;
				         // System.out.println(text.getText());
				          if((sofrom_Text.getText()!=null && sofrom_Text.getText().length()>0) || (soTo_Text.getText()!=null && soTo_Text.getText().length()>0) || btnCheckButton.getSelection())			 
		      ...
		      public void modifyText(ModifyEvent event) {
		    	  ...
		    	  try {
		    		// Get the widget whose text was modified
			          ...
			          //System.out.println(text.getText());
			          if((soTo_Text.getText()!=null &&  soTo_Text.getText().length()>0)||(sofrom_Text.getText()!=null && sofrom_Text.getText().length()>0) || btnCheckButton.getSelection())//&& sofrom_Text.getText()!=null && sofrom_Text.getText().length()>0)
			            btnNext.setEnabled(true);
			          else
			        	  btnNext.setEnabled(false);
		    	  } catch (Exception e) {
		...
		btnCheckButton.addSelectionListener(new SelectionAdapter()
		{
			...
			public void widgetSelected(SelectionEvent arg0) {
				...
				if(btnCheckButton.getSelection() || (sofrom_Text.getText()!=null && sofrom_Text.getText().length()>0) || (soTo_Text.getText()!=null && soTo_Text.getText().length()>0))
				{
